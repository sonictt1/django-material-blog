...
if ('serviceWorker' in navigator) {
  ...
  navigator.serviceWorker.register('/blog/push_notifications.js').then(function() {
...
function subscribe() {
  ...
  then(function(pushSubscription) {
    ...
    $.get('/blog/api/add_subscriber/', {"subscriberId": subscriberId});
  });
}
...
function unsubscribe() {
  sub.unsubscribe().then(function(event) {
    ...
    isSubscribed = false;
    var subscriberId = sub.endpoint.split("/").slice(-1);
    $.get('/blog/api/remove_subscriber/', {"subscriberId": subscriberId});
  }).catch(function(error) {
